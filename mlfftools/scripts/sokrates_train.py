...
def _create_train_state(
    ...
    from mlff.training import create_train_state
...
def save_parameters(params, outfile_inputs="inputs.json"):
...
def train_so3krates(
    ...
    echo(ctx.params)
    save_parameters(ctx.params, outfile_inputs=outfile_inputs)
